...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Çalışan | İzin Uygula</title>
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">İzin Başvurusu</div>
                    </div>
...
<option value="">İzin türünü seçin...</option>
