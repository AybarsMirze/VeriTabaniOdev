...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Çalışan | Geçmişten Ayrıl</title>
...
.succWrap{
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Yönetici ile sohbet edin</div>
                    </div>
    ...
    <aside>
                <p class="sidebar-chat-name">Tom Simpson<a href="#" data-activates="chat-messages" class="chat-message-link"><i class="material-icons">sağ klavye oku</i></a></p>
