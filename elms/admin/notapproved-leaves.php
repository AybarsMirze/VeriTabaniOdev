...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Yönetici | Onaylanmamış Yapraklar </title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"> Onaylanmamış İzin Geçmişi</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Onaylanmamış İzin Geçmişi</span>
...
if($stats==1){
 ...
 <?php } ?>
          ...
          <td>
           <td><a href="leave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="waves-effect waves-light btn blue m-b-xs"  > Detayları göster
 
</a></td>
                                    </tr>
                                         <?php $cnt++;} }?>
