...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Yönetici | Çalışan Ekle</title>
...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Çalışan ekle</div>
                    </div>
...
<div class="input-field col m6 s12">
<label for="city">Şehir / kent</label>
...
<div class="input-field col s12">
<button type="submit" name="add" onclick="return valid();" id="add" class="waves-effect waves-light btn indigo m-b-xs">Ekle</button>
