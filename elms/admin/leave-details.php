...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Yönetici | izin Ayrıntıları </title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="font-size:24px;">izin Ayrıntıları</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">izin Ayrıntıları</span>
...
{         
      ?>  
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Çalışan Adı :</b></td>
                                              ...
                                              <td style="font-size:16px;"><b>Çalışan Id :</b></td>
                                              <td><?php echo htmlentities($result->EmpId);?></td>
                                              <td style="font-size:16px;"><b>Cinsiyet :</b></td>
                                              <td><?php echo htmlentities($result->Gender);?></td>
                                          </tr>

                                          <tr>
                                             <td style="font-size:16px;"><b>Çalışan Mail :</b></td>
                                            <td><?php echo htmlentities($result->EmailId);?></td>
                                             <td style="font-size:16px;"><b>Çalışan İletişim Numarası. :</b></td>
  ...
  <tr>
                                             <td style="font-size:16px;"><b>izin tipi :</b></td>
                                            <td><?php echo htmlentities($result->LeaveType);?></td>
                                             <td style="font-size:16px;"><b>izin tipi . :</b></td>
                                            <td>itibaren <?php echo htmlentities($result->FromDate);?> ya <?php echo htmlentities($result->ToDate);?></td>
                                            <td style="font-size:16px;"><b>İlanı tarihi</b></td>
...
<tr>
<td style="font-size:16px;"><b>izin Durumu :</b></td>
<td colspan="5"><?php $stats=$result->Status;
if($stats==1){
?>
<span style="color: green">Onaylandı</span>
 <?php } if($stats==2)  { ?>
<span style="color: red">Onaylanmamış</span>
<?php } if($stats==0)  { ?>
 <span style="color: blue">onay bekleniyor</span>
 <?php } ?>
</td>
</tr>

<tr>
<td style="font-size:16px;"><b>Yönetici Açıklaması: </b></td>
<td colspan="5"><?php
...
?></td>
 ...
 <tr>
<td style="font-size:16px;"><b>Yönetici İşleminin yapıldığı tarih : </b></td>
<td colspan="5"><?php
...
<tr>
 <td colspan="5">
  <a class="modal-trigger waves-effect waves-light btn" href="#modal1">harekete&nbsp;geç</a>
<form name="adminaction" method="post">
<div id="modal1" class="modal modal-fixed-footer" style="height: 60%">
    <div class="modal-content" style="width:90%">
        <h4>izin harekete geç</h4>
          <select class="browser-default" name="status" required="">
                                            <option value="">Seçeneğinizi seçin</option>
                                            <option value="1">Onaylandı</option>
                                            <option value="2">Onaylanmamış</option>
                                        </select></p>
