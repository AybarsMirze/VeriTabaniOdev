...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Yönetici | Gösterge Paneli</title>
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Total Regd Çalışan</span>
...
?>
                        ...
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Listelenen Bölümler </span>
    <?php
...
?>                            
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title">Listelenen izin Tipi</span>
                                    <?php
                        ...
                        <div class="col s12 m12 l12">
                            <div class="card invoices-card">
                                <div class="card-content">
                                    ...
                                    <span class="card-title">Son İzin Uygulamaları</span>
...
if($stats==1){
                                             ?>
                                                ...
                                                <span style="color: red">Onaylanmamış</span>
                                                 <?php } if($stats==0)  { ?>
 <span style="color: blue">onay bekleniyor
 
</span>
 <?php } ?>
