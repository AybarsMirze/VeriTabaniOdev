...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Yönetici | Onaylanmış Yapraklar </title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Onaylanmış İzin Geçmişi</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Onaylanmış İzin Geçmişi</span>
                                <?php if($msg){?><div class="succWrap"><strong>SUCCESS</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th width="200">Çalışan Adı</th>
                                            <th width="120">İzin Tipi</th>

                                             <th width="180">İlanı tarihi</th>                 
                                            <th>Durum</th>
                                            <th align="center">Aksiyon</th>
                                        </tr>
                                    </thead>
...
if($stats==1){
 ...
 <?php } ?>
          ...
          <td>
           <td><a href="leave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="waves-effect waves-light btn blue m-b-xs"  > Detayları göster</a></td>
                                    </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
