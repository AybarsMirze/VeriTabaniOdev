...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Yönetici | Çalışanı Güncelle</title>
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Çalışanı güncelle</div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="updatemp">
                                    <div>
                                        <h3>Çalışanın bilgileri güncelle</h3>
...
<label for="empcode">Çalışan Kodu (Benzersiz olmalıdır)</label>
...
<div class="input-field col s12">
<label for="phone">Cep numarası</label>
...
<div class="input-field col s12">
<button type="submit" name="update"  id="update" class="waves-effect waves-light btn indigo m-b-xs">GÜNCELLE</button>
